  ...
  //อออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ
    ...
    //-------------------------------------------------------------------------
      ...
      //-----------------------------------------------------------------------
        ...
        typedef struct __ACEInitDllStruc
        {
          tACEGlobalDataStruc
                GlobalData;
    ...
    //-------------------------------------------------------------------------
      ...
      //-----------------------------------------------------------------------
        ...
        typedef struct __ACEReadArchiveDataStruc
        {
    ...
    //-------------------------------------------------------------------------
      ...
      //-----------------------------------------------------------------------
        ...
        typedef struct __ACEExtractStruc
        {
